...
<div class="row">
  <div class="col-sm-12">
    <div class="panel panel-default">
      <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Sınav Sonuçları
      ...
      <div class="panel-body">
        <form role="form" class="form-horizontal" method="post" action="<?=$this->_action?>" autocomplete="off" target="_blank">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="exam_id"> Sınav </label>
            <div class="col-sm-3">
              <select name="exam_id" id="exam_id" class="form-control input-sm" required="required">
                <option value="">Seçiniz</option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select name="subject_id" id="subject_id" class="form-control input-sm" required="required">
                <option value="">Seçiniz</option>
