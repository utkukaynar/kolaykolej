...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6"><span class="pull-right small"><strong>Sezon:</strong> <?php echo $season[$season_id]; ?> <strong>Sınav:</strong> <?php echo $exam[$exam_id]; ?> <strong>Ders:</strong> <?php echo $subject[$subject_id]; ?></span></div>
  </div>
  <div class="row">
    <div class="col-md-12">
      <table class="table table-striped table-full-width">
        <thead>
          <tr>
            ...
            <th>Soyadı</th>
            <th>Not</th>
            <th class="hidden-xs">Yorum</th>
            <th class="hidden-xs">Sınıf</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="hidden-xs"><?=$row->classroom;?></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
