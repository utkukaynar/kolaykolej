...
<div class="row">
  <div class="col-sm-12">
    <div class="panel panel-default">
      <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Öğrenci Listesi
      ...
      <div class="panel-body">
        <form role="form" class="form-horizontal" method="post" action="<?=$this->_action?>" autocomplete="off" target="_blank">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select name="gender_id" id="gender_id" class="form-control input-sm">
                <option value="">Seçiniz</option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select name="blood_group_id" id="blood_group_id" class="form-control input-sm">
                <option value="">Seçiniz</option>
