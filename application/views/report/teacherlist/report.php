...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6"><span class="pull-right small"><strong>Sezon:</strong> <?php echo $season[$season_id]; ?> <strong>Sınıf:</strong> <?php foreach ($classrooms as $value) { echo $classroom[$value]. ' '; } ?> <?php if (!empty($subject_id)) { ?><strong>Ders:</strong> <?php echo $subject[$subject_id]; ?> <?php } ?></span></div>
  </div>
  <div class="row">
    <div class="col-md-12">
